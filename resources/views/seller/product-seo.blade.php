                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['og_title'] }}" type="text" name="og_title" id="og_title"
                                 class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['og_keywords'] }}" type="text" name="og_keywords" id="og_keywords"
                                 class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="file_up">
                            <input type="text" name="og_image" id="og_image" value="{{ $datalist['og_image'] }}"
                          ...
                          <small class="form-text text-muted">e.g. Facebook share image. Recommended image size width:
                            600px and height: 315px.</small>
