                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="float-right">
                      <a href="{{ route('seller.products') }}" class="btn warning-btn"><i class="fa fa-reply"></i>
                        {{ __('Back to List') }}</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="tabs-body">
                  ...
                  <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                        ...
                        <div class="form-group">
                          ...
                          <select name="lan" id="lan" class="chosen-select form-control">
                            @foreach ($languageslist as $row)
                              <option {{ $row->language_code == $datalist['lan'] ? 'selected=selected' : '' }}
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['title'] }}" type="text" name="title" id="product_name"
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['slug'] }}" type="text" name="slug" id="slug"
                                 class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="brand_id" id="brand_id" class="chosen-select form-control">
                            ...
                            @foreach ($brandlist as $row)
                              <option {{ $row->id == $datalist['brand_id'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->name }}
                              </option>
                            @endforeach
                        ...
                        <div class="form-group">
                          ...
                          <select name="cat_id" id="cat_id" class="chosen-select form-control">
                            ...
                            @foreach ($categorylist as $row)
                              <option {{ $row->id == $datalist['cat_id'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->name }}
                              </option>
                            @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <select name="tax_id" id="tax_id" class="chosen-select form-control">
                            @foreach ($taxlist as $row)
                              <option {{ $row->id == $datalist['tax_id'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->title }}
                              </option>
                            @endforeach
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['sale_price'] }}" name="sale_price" id="sale_price"
                                 type="text" class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="variation_size" id="variation_size" class="chosen-select form-control">
                            @foreach ($unitlist as $row)
                              <option {{ $row->name == $datalist['variation_size'] ? 'selected=selected' : '' }}
                                      value="{{ $row->name }}">
                                {{ $row->name }}
                              </option>
                            @endforeach
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select name="is_featured" id="is_featured" class="chosen-select form-control">
                            <option {{ 1 == $datalist['is_featured'] ? 'selected=selected' : '' }} value="1">
                              {{ __('YES') }}</option>
                            <option {{ 0 == $datalist['is_featured'] ? 'selected=selected' : '' }} value="0">
                              {{ __('NO') }}</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select name="collection_id" id="collection_id" class="chosen-select form-control">
                            <option {{ 1 == $datalist['collection_id'] ? 'selected=selected' : '' }} value="1">
                              {{ __('YES') }}</option>
                            <option {{ 0 == $datalist['collection_id'] ? 'selected=selected' : '' }} value="0">
                              {{ __('NO') }}</option>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label for="f_thumbnail_thumbnail"><span class="red">*</span>
                            {{ __('Featured image') }}</label>
                          <div class="file_up">
                            <input type="text" name="f_thumbnail" id="f_thumbnail_thumbnail"
                                   value="{{ $datalist['f_thumbnail'] }}" class="form-control parsley-validated"
                          ...
                          <small class="form-text text-muted">Recommended image size width: 400px and height:
                            400px.</small>
                    ...
                    <input value="{{ $datalist['id'] }}" type="text" name="RecordId" id="RecordId"
                           class="dnone">
...
@push('scripts')
  ...
  <script type="text/javascript">
    ...
    TEXT['Sorry only you can upload jpg, png and gif file type'] =
      "{{ __('Sorry only you can upload jpg, png and gif file type') }}";
  </script>
