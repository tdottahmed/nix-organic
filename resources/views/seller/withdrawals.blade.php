              ...
              <div id="form-panel" class="card-body mb-15 dnone">
                <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label for="amount">{{ __('Amount') }} ({{ $gtext['currency_icon'] }})<span
                                class="red">*</span></label>
                        <input data-range="[1, 999999]" data-trigger="keyup" type="number" name="amount" id="amount"
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label for="fee_amount">{{ __('Fee') }} ({{ $gtext['currency_icon'] }})<span
                                class="red">*</span></label>
                        <input type="number" name="fee_amount" id="fee_amount" class="form-control parsley-validated"
                               value="{{ $gsellersettings['fee_withdrawal'] }}" data-required="true" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row">
...
@push('scripts')
  ...
  <script src="{{ asset('backend/pages/withdrawals_seller.js') }}"></script>
@endpush
