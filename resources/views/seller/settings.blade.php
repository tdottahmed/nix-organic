        ...
        <div class="row mt-25">
          <div class="col-lg-12">
            <div class="card">
              ...
              <!--/Data Entry Form-->
              <div class="card-body">
                <a onClick="onDetailsBankInfo(1)" href="javascript:void(0);" id="details_bank_info_1"
                   class="btn custom-btn details_bank_info active mr-10 font-bold">{{ __('Details') }}</a>
                <a onClick="onDetailsBankInfo(2)" href="javascript:void(0);" id="details_bank_info_2"
                   class="btn custom-btn details_bank_info font-bold">{{ __('Bank Information') }}</a>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="shop_name" id="shop_name" value="{{ $seller_data['shop_name'] }}"
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="shop_url" id="shop_url" value="{{ $seller_data['shop_url'] }}"
                                 class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="phone" id="phone" value="{{ $seller_data['phone'] }}"
                                 class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="address" id="address" value="{{ $seller_data['address'] }}"
                                 class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="city" id="city" value="{{ $seller_data['city'] }}"
                                 class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="state" id="state" value="{{ $seller_data['state'] }}"
                                 class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="zip_code" id="zip_code" value="{{ $seller_data['zip_code'] }}"
                                 class="form-control parsley-validated" data-required="true">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="country_id" id="country_id" class="chosen-select form-control">
                            @foreach ($countrylist as $row)
                              <option {{ $row->id == $seller_data['country_id'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->country_name }}
                              </option>
                            @endforeach
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="file_up">
                            <input type="text" name="photo" id="f_thumbnail_thumbnail"
                                   value="{{ $seller_data['photo'] }}" class="form-control parsley-validated"
                                   data-required="true" readonly>
                            <div class="file_browse_box">
                              <input type="file" name="load_image" id="load_image" class="file_browse">
                              <label for="load_image" class="file_browse_icon"><i
                                   class="fa fa-window-restore"></i>{{ __('Browse') }}</label>
                            </div>
                          </div>
                          <small class="form-text text-muted">Recommended image size width: 200px and height:
                            200px.</small>
                ...
                <div class="mt-15 dnone" id="bank_information">
                  <form novalidate="" data-validate="parsley" id="bankInformation_formId">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="bank_name" id="bank_name"
                                 value="{{ $bank_information['bank_name'] }}" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="bank_code" id="bank_code"
                                 value="{{ $bank_information['bank_code'] }}" class="form-control">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="account_number" id="account_number"
                                 value="{{ $bank_information['account_number'] }}" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="account_holder" id="account_holder"
                                 value="{{ $bank_information['account_holder'] }}" class="form-control">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="paypal_id" id="paypal_id"
                                 value="{{ $bank_information['paypal_id'] }}" class="form-control">
                        </div>
                      </div>
                    </div>
                    ...
                    <input type="text" id="seller_id" name="seller_id" value="{{ $seller_data['id'] }}"
                           class="dnone" />
                    <input type="text" id="bank_information_id" name="bank_information_id"
                           value="{{ $bank_information['id'] }}" class="dnone" />

                    <div class="row tabs-footer mt-15">
                      <div class="col-lg-12">
                        <a id="bank_information_submit_form" href="javascript:void(0);"
                           class="btn blue-btn mr-10">{{ __('Save') }}</a>
                      </div>
                    </div>
                  </form>
