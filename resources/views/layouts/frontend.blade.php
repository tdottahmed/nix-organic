...
<head>
  ...
  <link rel="shortcut icon"
        href="{{ $gtext['favicon'] ? asset('media/' . $gtext['favicon']) : asset('backend/images/favicon.ico') }}"
        type="image/x-icon">
  <link rel="icon"
        href="{{ $gtext['favicon'] ? asset('media/' . $gtext['favicon']) : asset('backend/images/favicon.ico') }}"
        type="image/x-icon">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700;900&family=Spartan:wght@400;500;700;800;900&display=swap"
        rel="stylesheet">
...
<body {!! $gtext['is_rtl'] == 1 ? 'class="rtl"' : '' !!}>
  ...
  @if ($PageVariation['home_variation'] == 'home_3')
    <div class="{{ $PageVariation['home_variation'] }} container">
      @yield('header')
      @yield('content')
