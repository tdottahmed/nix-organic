                    ...
                    <div class="item-image">
                      ...
                      @if ($row->is_discount == 1 && $row->end_date != '')
                        <div class="deals-countdown-card">
                          <div data-countdown="{{ date('Y/m/d', strtotime($row->end_date)) }}" class="deals-countdown">
                          </div>
                        </div>
                      @endif
                    </div>
          ...
          @foreach ($brand as $row)
            <div class="col-lg-12">
              <div class="brand-card">
                <a href="{{ route('frontend.brand', [$row->id, str_slug($row->name)]) }}"><img
                       src="{{ asset('media/' . $row->thumbnail) }}" alt="{{ $row->name }}" /></a>
              </div>
            </div>
          @endforeach
        </div>
