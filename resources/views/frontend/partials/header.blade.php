  ...
  <div class="top-header">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <ul class="top-list">
            <li><a href="{{ route('frontend.order-tracking') }}"><i class="bi bi-geo"></i>{{ __('Order Tracking') }}</a>
            </li>
            @auth
              <li>
                <div class="btn-group language-menu">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('frontend.my-dashboard') }}">{{ __('My Dashboard') }}</a>
                    </li>
            ...
            @else
              @if (Route::has('frontend.register'))
                <li><a href="{{ route('frontend.register') }}"><i class="bi bi-person-plus"></i>{{ __('Register') }}</a>
                </li>
              @endif
              @if (Route::has('login'))
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3">
          <div class="logo">
            <a href="{{ url('/') }}">
              <img src="{{ $gtext['front_logo'] ? asset('media/' . $gtext['front_logo']) : asset('frontend/images/logo.png') }}"
                   alt="logo">
            </a>
          </div>
        </div>
          ...
          <ul class="categories-wrap">
            <li>
              ...
              <ul class="nav-category-list">
                ...
                <li><a href="javascript:void(0);" class="btn cat-more-btn catMoreBtnActive"><span
                          class="onCatMoreBtn">{{ __('Show More') }}</span></a></li>
              </ul>
            </li>
          </ul>
        </div>
...
<aside class="mobile-menu-wrapper">
  ...
  <div class="offcanvas-body">
    ...
    <div class="search-for-mobile">
      <form method="GET" action="{{ route('frontend.search') }}">
        <input name="search" type="text" class="form-control" placeholder="{{ __('Search for Products') }}..."
               required />
