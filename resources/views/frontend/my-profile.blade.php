                      ...
                      <div class="col-md-12">
                        <div class="mb-3">
                          ...
                          <input id="name" name="name" type="text" class="form-control"
                                 placeholder="{{ __('Name') }}"
                                 value="@if (isset(Auth::user()->name)) {{ Auth::user()->name }} @endif" required />
                          @if ($errors->has('name'))
                      ...
                      <div class="col-md-12">
                        <div class="mb-3">
                          ...
                          <input id="email" name="email" type="email" class="form-control"
                                 ...
                                 value="@if (isset(Auth::user()->email)) {{ Auth::user()->email }} @endif" required
                                 readonly />
                          @if ($errors->has('email'))
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="mb-3">
                          ...
                          <textarea id="address" name="address" class="form-control" placeholder="{{ __('Address') }}" rows="4">
