                  ...
                  <tbody>
                    @foreach (session('shopping_cart') as $row)
                      ...
                      <tr id="row_delete_{{ $row['id'] }}">
                        ...
                        <td class="pro-variation-w text-center" data-title="{{ __('Unit') }}:">
                          <span class="pro-variation">{{ $row['unit'] }}</span>
                        </td>
                        <td class="pro-price-w text-center" data-title="{{ __('Price') }}:">
                          <span class="pro-price"><span class="pro-price">{{ $price }}</span></span>
                        </td>
                        <td class="pro-quantity-w text-center" data-title="{{ __('Quantity') }}:">
                          <div class="pro-quantity">{{ $row['qty'] }}</div>
                        </td>
                        <td class="pro-total-price-w text-center" data-title="{{ __('Total') }}:">
                          <span class="pro-total-price">{{ $totalPrice }}</span>
                        </td>
                        <td class="pro-remove-w text-center" data-title="Remove:">
                          <a data-id="{{ $row['id'] }}" id="removetoviewcart_{{ $row['id'] }}"
                             onclick="onRemoveToCart({{ $row['id'] }})" href="javascript:void(0);"
                             class="pro-remove"><i class="bi bi-x-lg"></i></a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
              ...
              <div class="carttotals-card">
                ...
                <div class="carttotals-body">
                  <table class="table">
                    <tbody>
                      <tr>
                        <td><span class="title">{{ __('Price Total') }}</span><span
                                class="price viewcart_price_total"></span></td>
                      </tr>
                      <tr>
                        <td><span class="title">{{ __('Tax') }}</span><span class="price viewcart_tax"></span>
                        </td>
                      </tr>
                      <tr>
                        <td><span class="title">{{ __('Subtotal') }}</span><span
                                class="price viewcart_sub_total"></span></td>
                      </tr>
                      <tr>
                        <td><span class="total">{{ __('Total') }}</span><span
                                class="total-price viewcart_total"></span></td>
                      </tr>
                    </tbody>
                  </table>
                  <a class="btn theme-btn mt10"
                     href="{{ route('frontend.checkout') }}">{{ __('Proceed To CheckOut') }}</a>
                </div>
              </div>
            </div>
          </div>
