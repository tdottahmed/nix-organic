                  ...
                  <tbody>
                    ...
                    @foreach (session('shopping_wishlist') as $row)
                      ...
                      <tr id="row_delete_{{ $row['id'] }}">
                        <td class="pro-remove-w text-center" data-title="{{ __('Remove') }}:">
                          <a data-id="{{ $row['id'] }}" id="removetowishlist_{{ $row['id'] }}"
                             onclick="onRemoveToWishlist({{ $row['id'] }})" href="javascript:void(0);"
                        ...
                        <td class="pro-addtocart-w text-center" data-title="{{ __('View') }}:">
                          <div class="pro-addtocart">
                            <a class="btn theme-btn cart"
                               href="{{ route('frontend.product', [$row['id'], str_slug($row['name'])]) }}">{{ __('View') }}</a>
                          </div>
                        </td>
                      </tr>
                    @endforeach
