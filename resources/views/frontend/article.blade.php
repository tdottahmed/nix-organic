...
@section('meta-content')
  ...
  <meta property="og:image"
        content="{{ $data->og_image ? asset('media/' . $data->og_image) : asset('media/' . $data->thumbnail) }}" />
            ...
            <div class="blog-details">
              ...
              <div class="share_this">
                ...
                <div class="social-media">
                  <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('frontend.article', [$data->id, $data->slug]) }}"
                     target="_blank"><i class="bi bi-facebook"></i></a>
                  <a href="https://twitter.com/intent/tweet?text={{ $data->title }}&url={{ route('frontend.article', [$data->id, $data->slug]) }}"
                     target="_blank"><i class="bi bi-twitter"></i></a>
                  <a href="http://www.linkedin.com/shareArticle?mini=true&url={{ route('frontend.article', [$data->id, $data->slug]) }}&title={{ $data->title }}&summary={{ $data->title }}"
                     target="_blank"><i class="bi bi-linkedin"></i></a>
                  <a href="https://wa.me/?text={{ route('frontend.article', [$data->id, $data->slug]) }}"
