            ...
            <div class="row mt10 mb5">
              <div class="col-md-12 text-center">
                <a href="{{ route('frontend.register') }}"
                   class="btn white-btn text-initial mr10 mb5 font-bold">{{ __('I am a customer') }}</a>
                <a href="{{ route('frontend.seller-register') }}"
                   class="btn white-btn text-initial mb5 active font-bold">{{ __('I am a seller') }}</a>
              </div>
            </div>
            <div class="register">
              ...
              <form class="form" method="POST" action="{{ route('frontend.sellerRegister') }}">
                ...
                <div class="form-group">
                  <input name="shop_name" type="text" class="form-control @error('shop_name') is-invalid @enderror"
                ...
                <div class="form-group">
                  <input name="shop_url" id="shop_url" type="text"
                         class="form-control @error('shop_url') is-invalid @enderror"
                         placeholder="{{ __('Shop URL') }}" value="{{ old('shop_url') }}" required />
                ...
                <div class="form-group">
                  <input name="shop_phone" type="text"
                         class="form-control @error('shop_phone') is-invalid @enderror"
                         placeholder="{{ __('Shop Phone') }}" value="{{ old('shop_phone') }}" required />
