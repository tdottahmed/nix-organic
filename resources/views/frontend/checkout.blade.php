                ...
                <div class="col-md-12">
                  ...
                  @if ($gtext['stripe_isenable'] == 1)
                    <div class="payment_card">
                      <div class="checkboxlist">
                        <label class="checkbox-title">
                          <input id="payment_method_stripe" name="payment_method" type="radio" value="3"><img
                               src="{{ asset('frontend/images/stripe.png') }}" alt="Stripe" />
                        </label>
                      </div>
                  ...
                  @if ($gtext['isenable_paypal'] == 1)
                    <div class="payment_card">
                      <div class="checkboxlist">
                        <label class="checkbox-title">
                          <input id="payment_method_paypal" name="payment_method" type="radio" value="4"><img
                               src="{{ asset('frontend/images/paypal.png') }}" alt="Paypal" />
                        </label>
                      </div>
                  ...
                  @if ($gtext['isenable_razorpay'] == 1)
                    <div class="payment_card">
                      <div class="checkboxlist">
                        <label class="checkbox-title">
                          <input id="payment_method_razorpay" name="payment_method" type="radio" value="5"><img
                               src="{{ asset('frontend/images/razorpay.png') }}" alt="Razorpay" />
                        </label>
                      </div>
                      ...
                      <div class="checkboxlist">
                        <label class="checkbox-title">
                          <input id="payment_method_mollie" name="payment_method" type="radio" value="6"><img
                               src="{{ asset('frontend/images/mollie.png') }}" alt="Mollie" />
                        </label>
                      </div>
                  ...
                  @if ($gtext['cod_isenable'] == 1)
                    <div class="payment_card">
                      <div class="checkboxlist">
                        <label class="checkbox-title">
                          <input id="payment_method_cod" name="payment_method" type="radio" value="1"><img
                               src="{{ asset('frontend/images/cash_on_delivery.png') }}" alt="Cash on Delivery" />
                        </label>
                      </div>
                  ...
                  @if ($gtext['bank_isenable'] == 1)
                    <div class="payment_card">
                      <div class="checkboxlist">
                        <label class="checkbox-title">
                          <input id="payment_method_bank" name="payment_method" type="radio" value="2"><img
                               src="{{ asset('frontend/images/bank_transfer.png') }}" alt="Bank Transfer" />
                        </label>
                      </div>
                        ...
                        @foreach ($CartData_Arr as $row)
                              ...
                              <td colspan="2" class="tp_group">
                                <div class="store_logo">
                                  <a
                                    ...
                                    <img src="{{ asset('media/' . $row['store_logo']) }}"
                                         alt="{{ $row['store_name'] }}" />
                                  </a>
                                </div>
                          ...
                          @if ($gtext['currency_position'] == 'left')
                            <tr>
                              ...
                              <td>
                                <p class="price">
                                  {{ $gtext['currency_icon'] }}{{ NumberFormat($row['price'] * $row['qty']) }}</p>
                          ...
                          @else
                            <tr>
                              ...
                              <td>
                                <p class="price">
                                  {{ NumberFormat($row['price'] * $row['qty']) }}{{ $gtext['currency_icon'] }}</p>
