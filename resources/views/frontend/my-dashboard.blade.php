        ...
        <div class="row my-dashbord">
          ...
          <div class="col-sm-12 col-md-8 col-lg-9 col-xl-9">
            <div class="my_card">
              <div class="row">
                <div class="col-lg-12">
                  <h4>{{ __('Hello') }}, @if (isset(Auth::user()->name))
                      {{ Auth::user()->name }}
                    @endif
                  </h4>
                  <p>From your account dashboard. you can view your <strong><a
                         href="{{ route('frontend.my-orders') }}">recent orders</a></strong>, <strong><a
                         href="{{ route('frontend.my-profile') }}">profile</a></strong> and <strong><a
                         href="{{ route('frontend.change-password') }}">change password</a></strong>.</p>
                </div>
              </div>
            </div>
          </div>
