                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="blog_title" id="blog_title" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="slug" id="slug" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group tpeditor">
                        ...
                        <textarea name="description" id="description" class="form-control parsley-validated" data-required="true"
                                  rows="5"></textarea>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          <input type="text" name="thumbnail" id="category_thumbnail"
                                 class="form-control parsley-validated" data-required="true" readonly>
                          <a id="on_thumbnail" href="javascript:void(0);" class="tp-upload-btn"><i
                               class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                        </div>
                        <em>Recommended image size width: 800px and height: 800px.</em>
                        <div id="remove_category_thumbnail" class="select-image">
                          <div class="inner-image" id="view_category_thumbnail"></div>
                          <a onClick="onMediaImageRemove('category_thumbnail')" class="media-image-remove"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          ...
                          <a id="on_og_image" href="javascript:void(0);" class="tp-upload-btn"><i
                               class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                        </div>
                        ...
                        <div id="remove_og_image" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('og_image')" class="media-image-remove"
                             href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                        </div>
                      </div>
                    </div>
