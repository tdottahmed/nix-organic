                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input value="{{ $datalist['title'] }}" type="text" name="title" id="trending_title"
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input value="{{ $datalist['url'] }}" type="text" name="url" id="url"
                               class="form-control parsley-validated" data-required="true">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input value="{{ $datalist['video_url'] }}" type="text" name="video_url" id="video_url"
                               class="form-control parsley-validated" data-required="true">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          <input value="{{ $datalist['image'] }}" type="text" name="image" id="trending_image"
                        ...
                        <div id="remove_trending_image" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('trending_image')" class="media-image-remove"
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="target" id="target" class="chosen-select form-control">
                          ...
                          <option {{ $datalist['target'] == '_self' ? 'selected=selected' : '' }} value="_self">Self
                          </option>
                          <option {{ $datalist['target'] == '_blank' ? 'selected=selected' : '' }} value="_blank">Blank
                          </option>
                        </select>
                      </div>
                    </div>
