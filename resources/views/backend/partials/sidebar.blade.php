<div class="sidebar-wrapper">
  <div class="logo">
    <a href="{{ route('backend.dashboard') }}">
      <img src="{{ $gtext['back_logo'] ? asset('media/' . $gtext['back_logo']) : asset('backend/images/backend-logo.png') }}"
           alt="logo">
    </a>
  </div>
  <ul class="left-navbar">
    @if (Auth::user()->role_id == 1)
      ...
      <li><a href="{{ route('backend.orders') }}" id="select_orders"><i class="fa fa-rocket"></i>{{ __('Orders') }}</a>
      </li>
      ...
      <li class="dropdown"><a class="nav-link has-dropdown" href="#" data-toggle="dropdown"><i
             class="fa fa-pencil-square-o"></i>{{ __('Blog') }}</a>
        <ul class="dropdown-menu">
    ...
    @elseif (Auth::user()->role_id == 3)
      ...
      <li><a href="{{ route('seller.orders') }}" id="select_order"><i
             class="fa fa-rocket"></i>{{ __('Orders') }}</a></li>
