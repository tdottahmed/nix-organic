<nav class="navbar-expand-lg navbar tp-header">
  ...
  @elseif (Auth::user()->role_id == 3)
    <a href="{{ route('frontend.stores', [Auth::user()->id, str_slug(Auth::user()->shop_url)]) }}" target="_blank"
       class="view_website">{{ __('View Your Store') }}</a>
  @endif

  <div class="dropdown mt-lg-0 ml-auto mt-0">
