            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div id="form-panel" class="dnone">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <small class="form-text text-muted">Example: af, bn, en, fr, pt (<a target="_blank"
                               href="https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes">List of Langauges name and
                              Codes</a>) </small>
                        </div>
                      </div>
                      <div class="col-md-6">
                  ...
                  <div class="row mt-15">
                    <div class="col-md-12">
                      <p>Note: <span class="text-danger">Please give write permissions in this folder
                          "resources/lang".</span></p>
                    </div>
                  </div>
                </div>
                <!--/Data Entry Form-->
