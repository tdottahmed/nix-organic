                          ...
                          <div id="is_smtp" {{ $datalist['mailer'] == 'smtp' ? '' : 'class=dnone' }}>
                            ...
                            <div class="form-group">
                              ...
                              <input type="number" name="smtp_port" id="smtp_port" class="form-control"
                                     value="{{ $datalist['smtp_port'] }}" placeholder="587">
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <select name="smtp_security" id="smtp_security" class="chosen-select form-control">
                                <option value="tls"
                                        {{ $datalist['smtp_security'] == 'tls' ? 'selected="selected"' : '' }}>TLS
                                </option>
                                <option value="ssl"
                                        {{ $datalist['smtp_security'] == 'ssl' ? 'selected="selected"' : '' }}>SSL
                                </option>
                              </select>
                            </div>
                            <div class="form-group">
