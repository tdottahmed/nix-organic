              ...
              <div class="card-body">
                ...
                <form novalidate="" data-validate="parsley" id="mailchimp_formId">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="mailchimp_api_key" id="mailchimp_api_key"
                               ...
                               value="{{ $datalist['mailchimp_api_key'] }}">
                        <small class="form-text text-muted"><a target="_blank" href="https://mailchimp.com/">Creating
                            MailChimp API Key</a></small>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="audience_id" id="audience_id" class="form-control parsley-validated"
                               data-required="true" value="{{ $datalist['audience_id'] }}">
                      </div>
                    </div>
                    <div class="col-md-6"></div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="tw_checkbox checkbox_group">
                        <input id="is_mailchimp" name="is_mailchimp" type="checkbox"
                               {{ $datalist['is_mailchimp'] == 1 ? 'checked' : '' }}>
                  ...
                  <div class="row tabs-footer mt-15">
                    <div class="col-lg-12">
                      <a id="mailchimp_submit_form" href="javascript:void(0);"
