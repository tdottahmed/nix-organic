                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label for="twitter_id">Twitter:site (<a target="_blank"
                               href="https://twitter.com">Twitter</a>)</label>
                          <input value="{{ $datalist['twitter_id'] }}" type="text" name="twitter_id" id="twitter_id"
