                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          <input type="text" name="thumbnail" id="category_thumbnail" class="form-control"
                                 readonly>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          <input type="text" name="subheader_image" id="subheader_image" class="form-control"
                                 readonly>
                          <a id="on_subheader_image" href="javascript:void(0);" class="tp-upload-btn"><i
                               class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                        </div>
                        ...
                        <div id="remove_subheader_image" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('subheader_image')" class="media-image-remove"
                             href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                        </div>
                      </div>
                    </div>
