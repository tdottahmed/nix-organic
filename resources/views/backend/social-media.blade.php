                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="social_icon" id="social_icon"
                                   class="form-control parsley-validated" data-required="true"
                                   placeholder="bi bi-facebook">
                          </div>
                          <em>Choose bootstrap icon <a href="https://icons.getbootstrap.com/"
                               target="_blank">https://icons.getbootstrap.com/</a></em>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
