                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select data-placeholder="{{ __('Select Size') }}" name="variation_size[]" id="variation_size"
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select data-placeholder="{{ __('Select color') }}" name="variation_color[]"
                                  id="variation_color" class="chosen-select form-control" multiple>
