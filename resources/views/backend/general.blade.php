                      ...
                      <div class="row">
                        <div class="col-lg-8">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="site_name" id="site_name" class="form-control parsley-validated"
                                   data-required="true" value="{{ $datalist['site_name'] }}">
                          </div>
                          <div class="form-group">
                            <label for="site_title">{{ __('Site Title') }}<span class="red">*</span></label>
                            <input type="text" name="site_title" id="site_title" class="form-control parsley-validated"
                                   data-required="true" value="{{ $datalist['site_title'] }}">
                          </div>
                          <div class="form-group">
                            <label for="company">{{ __('Company') }}<span class="red">*</span></label>
                            <input type="text" name="company" id="company" class="form-control parsley-validated"
                                   data-required="true" value="{{ $datalist['company'] }}">
                          </div>
                          <div class="form-group">
                            ...
                            <input type="text" name="email" id="email" class="form-control parsley-validated"
                                   data-required="true" value="{{ $datalist['email'] }}">
                          </div>
                          <div class="form-group">
                            ...
                            <input type="text" name="phone" id="phone" class="form-control parsley-validated"
                                   data-required="true" value="{{ $datalist['phone'] }}">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <select name="timezone" id="timezone" class="chosen-select form-control parsley-validated"
                                    data-required="true">
                              @foreach ($timezonelist as $row)
                                <option {{ $row->timezone == $datalist['timezone'] ? 'selected=selected' : '' }}
                                        value="{{ $row->timezone }}">
                                  {{ $row->timezone_name }}
                                </option>
                              @endforeach
