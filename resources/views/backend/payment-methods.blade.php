                  ...
                  <div class="col-lg-12">
                    <div class="float-right">
                      <a onClick="onListPanel()" href="javascript:void(0);"
                         class="btn warning-btn btn-list dnone float-right"><i class="fa fa-reply"></i>
                        {{ __('Back to List') }}</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12">
                    ...
                    <div id="list-panel">
                      <div class="table-responsive">
                        <table class="table-borderless table-theme table" style="width:100%;">
                          <tbody>
                            <tr>
                              ...
                              <td class="text-center" width="5%">
                                <div class="btn-group action-group">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <a onclick="onEdit(1)" class="dropdown-item"
                              ...
                              <td class="text-center" width="5%">
                                <div class="btn-group action-group">
                                  <a class="action-btn" href="javascript:void(0);" data-toggle="dropdown"
                                     aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <a onclick="onEdit(4)" class="dropdown-item"
                                       href="javascript:void(0);">{{ __('Edit') }}</a>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td class="text-center" width="5%">
                                <div class="btn-group action-group">
                                  <a class="action-btn" href="javascript:void(0);" data-toggle="dropdown"
                                     aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <a onclick="onEdit(5)" class="dropdown-item"
                                       href="javascript:void(0);">{{ __('Edit') }}</a>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td class="text-center" width="5%">
                                <div class="btn-group action-group">
                                  <a class="action-btn" href="javascript:void(0);" data-toggle="dropdown"
                                     aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <a onclick="onEdit(6)" class="dropdown-item"
                                       href="javascript:void(0);">{{ __('Edit') }}</a>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td class="text-center" width="5%">
                                <div class="btn-group action-group">
                                  <a class="action-btn" href="javascript:void(0);" data-toggle="dropdown"
                                     aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <a onclick="onEdit(2)" class="dropdown-item"
                                       href="javascript:void(0);">{{ __('Edit') }}</a>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td class="text-center" width="5%">
                                <div class="btn-group action-group">
                                  <a class="action-btn" href="javascript:void(0);" data-toggle="dropdown"
                                     aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <a onclick="onEdit(3)" class="dropdown-item"
                                       href="javascript:void(0);">{{ __('Edit') }}</a>
                                  </div>
                                </div>
                              </td>
                    ...
                    <div id="form-panel-1" class="dnone">
                      <form novalidate="" data-validate="parsley" id="stripe_formId">
                        ...
                        <div class="row">
                          <div class="col-lg-8">
                            <div class="tw_checkbox checkbox_group">
                              <input id="isenable" name="isenable" type="checkbox"
                                     {{ $stripe_data_list['isenable'] == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="stripe_key" id="stripe_key"
                                     ...
                                     value="{{ $stripe_data_list['stripe_key'] }}">
                            </div>
                            <div class="form-group">
                              <label for="stripe_secret">{{ __('Stripe Secret') }}<span class="red">*</span></label>
                              <input type="text" name="stripe_secret" id="stripe_secret"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $stripe_data_list['stripe_secret'] }}">
                              <small class="form-text text-muted"><a target="_blank" href="https://stripe.com/">Create
                                  an Account Stripe</a></small>
                            </div>
                            <div class="form-group">
                              <label for="currency">{{ __('Currency') }}<span class="red">*</span></label>
                              <input type="text" name="currency" id="currency"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $stripe_data_list['currency'] }}">
                              <small class="form-text text-muted"><a target="_blank"
                                   href="https://stripe.com/docs/currencies">Currencies</a></small>
                            </div>
                          </div>
                        ...
                        <div class="row tabs-footer mt-15">
                          <div class="col-lg-12">
                            <a id="submit-form-stripe" href="javascript:void(0);"
                    ...
                    <div id="form-panel-4" class="dnone">
                      <form novalidate="" data-validate="parsley" id="paypal_formId">
                        ...
                        <div class="row">
                          <div class="col-lg-8">
                            <div class="tw_checkbox checkbox_group">
                              <input id="isenable_paypal" name="isenable_paypal" type="checkbox"
                                     {{ $paypal_data_list['isenable_paypal'] == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="paypal_client_id" id="paypal_client_id"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $paypal_data_list['paypal_client_id'] }}">
                            </div>
                            <div class="form-group">
                              <label for="paypal_secret">{{ __('Secret') }}<span class="red">*</span></label>
                              <input type="text" name="paypal_secret" id="paypal_secret"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $paypal_data_list['paypal_secret'] }}">
                              <small class="form-text text-muted"><a target="_blank"
                                   href="https://www.paypal.com/">Create an Account Paypal</a></small>
                            </div>
                            <div class="form-group">
                              <label for="paypal_currency">{{ __('Currency') }}<span class="red">*</span></label>
                              <input type="text" name="paypal_currency" id="paypal_currency"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $paypal_data_list['paypal_currency'] }}">
                              <small class="form-text text-muted"><a target="_blank"
                                   href="https://developer.paypal.com/docs/reports/reference/paypal-supported-currencies/">Currencies</a></small>
                            </div>
                            <div class="tw_checkbox checkbox_group">
                              <input id="ismode_paypal" name="ismode_paypal" type="checkbox"
                                     {{ $paypal_data_list['ismode_paypal'] == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row tabs-footer mt-15">
                          <div class="col-lg-12">
                            <a id="submit-form-paypal" href="javascript:void(0);"
                               class="btn blue-btn mr-10">{{ __('Save') }}</a>
                          </div>
                        </div>
                      </form>
                    ...
                    <div id="form-panel-5" class="dnone">
                      <form novalidate="" data-validate="parsley" id="razorpay_formId">
                        ...
                        <div class="row">
                          <div class="col-lg-8">
                            <div class="tw_checkbox checkbox_group">
                              <input id="isenable_razorpay" name="isenable_razorpay" type="checkbox"
                                     {{ $razorpay_data_list['isenable_razorpay'] == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="razorpay_key_id" id="razorpay_key_id"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $razorpay_data_list['razorpay_key_id'] }}">
                            </div>
                            <div class="form-group">
                              <label for="razorpay_key_secret">{{ __('Key Secret') }}<span
                                      class="red">*</span></label>
                              <input type="text" name="razorpay_key_secret" id="razorpay_key_secret"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $razorpay_data_list['razorpay_key_secret'] }}">
                              <small class="form-text text-muted"><a target="_blank"
                                   href="https://razorpay.com/">Create an Account Razorpay</a></small>
                            </div>
                            <div class="form-group">
                              <label for="razorpay_currency">{{ __('Currency') }}<span class="red">*</span></label>
                              <input type="text" name="razorpay_currency" id="razorpay_currency"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $razorpay_data_list['razorpay_currency'] }}">
                            </div>
                            <div class="tw_checkbox checkbox_group">
                              <input id="ismode_razorpay" name="ismode_razorpay" type="checkbox"
                                     {{ $razorpay_data_list['ismode_razorpay'] == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row tabs-footer mt-15">
                          <div class="col-lg-12">
                            <a id="submit-form-razorpay" href="javascript:void(0);"
                               class="btn blue-btn mr-10">{{ __('Save') }}</a>
                          </div>
                        </div>
                      </form>
                    ...
                    <div id="form-panel-6" class="dnone">
                      <form novalidate="" data-validate="parsley" id="mollie_formId">
                        ...
                        <div class="row">
                          <div class="col-lg-8">
                            <div class="tw_checkbox checkbox_group">
                              <input id="isenable_mollie" name="isenable_mollie" type="checkbox"
                                     {{ $mollie_data_list['isenable_mollie'] == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="mollie_api_key" id="mollie_api_key"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $mollie_data_list['mollie_api_key'] }}">
                              <small class="form-text text-muted"><a target="_blank"
                                   href="https://www.mollie.com/">Create an Account Mollie</a></small>
                            </div>
                            <div class="form-group">
                              <label for="mollie_currency">{{ __('Currency') }}<span class="red">*</span></label>
                              <input type="text" name="mollie_currency" id="mollie_currency"
                                     class="form-control parsley-validated" data-required="true"
                                     value="{{ $mollie_data_list['mollie_currency'] }}">
                              <small class="form-text text-muted"><a target="_blank"
                                   href="https://docs.mollie.com/payments/multicurrency">Currencies</a></small>
                            </div>
                            <div class="tw_checkbox checkbox_group">
                              <input id="ismode_mollie" name="ismode_mollie" type="checkbox"
                                     {{ $mollie_data_list['ismode_mollie'] == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row tabs-footer mt-15">
                          <div class="col-lg-12">
                            <a id="submit-form-mollie" href="javascript:void(0);"
                               class="btn blue-btn mr-10">{{ __('Save') }}</a>
                          </div>
                        </div>
                      </form>
                    ...
                    <div id="form-panel-2" class="dnone">
                      <form novalidate="" data-validate="parsley" id="cod_formId">
                        ...
                        <div class="row tabs-footer mt-15">
                          <div class="col-lg-12">
                            <a id="submit-form-cod" href="javascript:void(0);"
                               class="btn blue-btn mr-10">{{ __('Save') }}</a>
                          </div>
                        </div>
                      </form>
                    ...
                    <div id="form-panel-3" class="dnone">
                      <form novalidate="" data-validate="parsley" id="bank_formId">
                        ...
                        <div class="row tabs-footer mt-15">
                          <div class="col-lg-12">
                            <a id="submit-form-bank" href="javascript:void(0);"
                               class="btn blue-btn mr-10">{{ __('Save') }}</a>
                          </div>
                        </div>
                      </form>
