                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="code" id="code" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="expire_date" id="expire_date" class="form-control parsley-validated"
                               data-required="true" placeholder="yyyy-mm-dd">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" name="percentage" id="percentage" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                    <div class="col-md-6">
