                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['whatsapp_id'] }}" type="text" name="whatsapp_id" id="whatsapp_id"
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['whatsapp_text'] }}" type="text" name="whatsapp_text"
                                 id="whatsapp_text" class="form-control" placeholder="Text..">
                        </div>
                      </div>
                      <div class="col-lg-6"></div>
                    </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="position" id="position" class="chosen-select form-control">
                            ...
                            <option {{ 'right' == $datalist['position'] ? 'selected=selected' : '' }} value="right">Right
                            </option>
                          </select>
                        </div>
                      </div>
