                      ...
                      <div class="row">
                        <div class="col-lg-8">
                          <div class="tw_checkbox checkbox_group">
                            <input id="is_googlemap" name="is_googlemap" type="checkbox"
                                   {{ $datalist['is_googlemap'] == 1 ? 'checked' : '' }}>
                            <label for="is_googlemap">{{ __('Enable/Disable') }}</label>
                            <span></span>
                          </div>
                          <div class="form-group">
                            <label for="googlemap_apikey">{{ __('Site Key') }}<span class="red">*</span></label>
                            <input type="text" name="googlemap_apikey" id="googlemap_apikey"
                                   class="form-control parsley-validated" data-required="true"
                                   value="{{ $datalist['googlemap_apikey'] }}">
                          </div>
                        </div>
