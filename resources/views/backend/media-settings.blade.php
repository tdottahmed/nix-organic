                        ...
                        <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <p>The sizes listed below determine the maximum dimensions in pixels to use when adding an
                                image to the Media.</p>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="number" name="media_width" id="media_width"
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="number" name="media_height" id="media_height"
                                       class="form-control parsley-validated" data-required="true">
                              </div>
                            </div>
                          </div>
