                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['google_tag_manager_id'] }}" type="text"
                                 name="google_tag_manager_id" id="google_tag_manager_id" class="form-control"
                                 placeholder="GTM-PVPT123">
                          <small class="form-text text-muted">e.g. <strong>Google Tag Manager ID:
                              GTM-PVPT123</strong></small>
                        </div>
                      </div>
                    </div>
                    <div class="row">
