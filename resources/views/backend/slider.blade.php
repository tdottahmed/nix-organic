                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="slider_title" id="slider_title" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          ...
                          <a id="on_slider_image" href="javascript:void(0);" class="tp-upload-btn"><i
                        ...
                        <div id="remove_slider_image" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('slider_image')" class="media-image-remove"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          ...
                          <a id="on_layer_image_1" href="javascript:void(0);" class="tp-upload-btn"><i
                               class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                        </div>
                        ...
                        <div id="remove_layer_image_1" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('layer_image_1')" class="media-image-remove"
                             href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          ...
                          <a id="on_layer_image_2" href="javascript:void(0);" class="tp-upload-btn"><i
                               class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                        </div>
                        ...
                        <div id="remove_layer_image_2" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('layer_image_2')" class="media-image-remove"
                             href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="tp-upload-field">
                          ...
                          <a id="on_layer_image_3" href="javascript:void(0);" class="tp-upload-btn"><i
                               class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                        </div>
                        ...
                        <div id="remove_layer_image_3" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('layer_image_3')" class="media-image-remove"
                             href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                        </div>
                      </div>
                    </div>
