              ...
              <div class="card-body">
                ...
                <form novalidate="" data-validate="parsley" id="subscribe_popup_formId">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{ $datalist['subscribe_title'] }}" name="subscribe_title"
                               id="subscribe_title" class="form-control parsley-validated" data-required="true">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="bg_image_popup">{{ __('Background Image') }} For Popup Modal<span
                                class="red">*</span></label>
                        <div class="tp-upload-field">
                          <input type="text" value="{{ $datalist['bg_image_popup'] }}" name="bg_image_popup"
                                 id="bg_image_popup" class="form-control" readonly>
                          <a id="on_bg_image_popup" href="javascript:void(0);" class="tp-upload-btn"><i
                        ...
                        <div id="remove_bg_image_popup" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('bg_image_popup')" class="media-image-remove"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="background_image">{{ __('Background Image') }} For Footer<span
                                class="red">*</span></label>
                        <div class="tp-upload-field">
                          <input type="text" value="{{ $datalist['background_image'] }}" name="background_image"
                                 id="background_image" class="form-control" readonly>
                          <a id="on_background_image" href="javascript:void(0);" class="tp-upload-btn"><i
                               class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                        </div>
                        ...
                        <div id="remove_background_image" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('background_image')" class="media-image-remove"
                             href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="tw_checkbox checkbox_group">
                        <input id="is_subscribe_popup" name="is_subscribe_popup" type="checkbox"
                               {{ $datalist['is_subscribe_popup'] == 1 ? 'checked' : '' }}>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="tw_checkbox checkbox_group">
                        <input id="is_subscribe_footer" name="is_subscribe_footer" type="checkbox"
                               {{ $datalist['is_subscribe_footer'] == 1 ? 'checked' : '' }}>
                  ...
                  <div class="row tabs-footer mt-15">
                    <div class="col-lg-12">
                      <a id="subscribe_popup_submit_form" href="javascript:void(0);"
