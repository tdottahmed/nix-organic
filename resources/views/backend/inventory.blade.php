                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="is_stock" id="is_stock" class="chosen-select form-control">
                            <option {{ 1 == $datalist['is_stock'] ? 'selected=selected' : '' }} value="1">
                              {{ __('YES') }}</option>
                            <option {{ 0 == $datalist['is_stock'] ? 'selected=selected' : '' }} value="0">
                              {{ __('NO') }}</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="stock_status_id" id="stock_status_id" class="chosen-select form-control">
                            <option {{ 1 == $datalist['stock_status_id'] ? 'selected=selected' : '' }} value="1">
                              {{ __('In Stock') }}</option>
                            <option {{ 0 == $datalist['stock_status_id'] ? 'selected=selected' : '' }} value="0">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['sku'] }}" name="sku" id="sku" type="text"
                                 class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['stock_qty'] }}" name="stock_qty" id="stock_qty" type="number"
                                 class="form-control">
                        </div>
                      </div>
                    </div>
