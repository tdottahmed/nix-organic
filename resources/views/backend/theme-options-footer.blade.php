                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="tp-upload-field">
                            <input type="text" value="{{ $datalist['payment_gateway_icon'] }}" name="about_logo"
                                   id="about_logo" class="form-control" readonly>
                            <a id="on_about_logo" href="javascript:void(0);" class="tp-upload-btn"><i
                          ...
                          <div id="remove_about_logo" class="select-image dnone">
                            ...
                            <a onClick="onMediaImageRemove('about_logo')" class="media-image-remove"
                        ...
                        <div class="form-group">
                          ...
                          <select name="is_publish_about" id="is_publish_about" class="chosen-select form-control">
                            @foreach ($statuslist as $row)
                              <option {{ $row->id == $datalist['is_publish_about'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->status }}
                              </option>
                            @endforeach
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['address'] }}" type="text" name="address" id="address"
                                 class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['email'] }}" type="text" name="email" id="email"
                                 class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['phone'] }}" type="text" name="phone" id="phone"
                                 class="form-control">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="is_publish_contact" id="is_publish_contact" class="chosen-select form-control">
                            @foreach ($statuslist as $row)
                              <option {{ $row->id == $datalist['is_publish_contact'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->status }}
                              </option>
                            @endforeach
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['copyright'] }}" type="text" name="copyright" id="copyright"
                                 class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="is_publish_copyright" id="is_publish_copyright"
                                  class="chosen-select form-control">
                            @foreach ($statuslist as $row)
                              <option {{ $row->id == $datalist['is_publish_copyright'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->status }}
                              </option>
                            @endforeach
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="tp-upload-field">
                            <input value="{{ $datalist['payment_gateway_icon'] }}" type="text"
                                   name="payment_gateway_icon" id="payment_gateway_icon" class="form-control" readonly>
                            <a id="on_payment_gateway_icon" href="javascript:void(0);" class="tp-upload-btn"><i
                                 class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                          </div>
                          ...
                          <div id="remove_payment_gateway_icon" class="select-image dnone">
                            ...
                            <a onClick="onMediaImageRemove('payment_gateway_icon')" class="media-image-remove"
                               href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="is_publish_payment" id="is_publish_payment" class="chosen-select form-control">
                            @foreach ($statuslist as $row)
                              <option {{ $row->id == $datalist['is_publish_payment'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->status }}
                              </option>
                            @endforeach
