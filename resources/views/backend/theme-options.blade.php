                      ...
                      <div class="col-md-8">
                        ...
                        <div class="form-group">
                          ...
                          <div class="tp-upload-field">
                            <input value="{{ $datalist['favicon'] }}" name="favicon" id="favicon" type="text"
                                   class="form-control" readonly>
                            <a id="on_favicon" href="javascript:void(0);" class="tp-upload-btn"><i
                          ...
                          <div id="remove_favicon" class="select-image dnone">
                            ...
                            <a onClick="onMediaImageRemove('favicon')" class="media-image-remove"
                        ...
                        <div class="form-group">
                          ...
                          <div class="tp-upload-field">
                            <input value="{{ $datalist['front_logo'] }}" name="front_logo" id="front_logo" type="text"
                                   class="form-control" readonly>
                            <a id="on_front_logo" href="javascript:void(0);" class="tp-upload-btn"><i
                                 class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                          </div>
                          <em>Recommended front logo size width: 250px and height: 85px. The logo must be a file of type
                            png</em>
                          <div id="remove_front_logo" class="select-image dnone">
                            <div class="inner-image" id="view_front_logo"></div>
                            <a onClick="onMediaImageRemove('front_logo')" class="media-image-remove"
                               href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="tp-upload-field">
                            <input value="{{ $datalist['back_logo'] }}" name="back_logo" id="back_logo" type="text"
                                   class="form-control" readonly>
                            <a id="on_back_logo" href="javascript:void(0);" class="tp-upload-btn"><i
                                 class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                          </div>
                          <em>Recommended front logo size width: 250px and height: 85px. The logo must be a file of type
                            png</em>
                          <div id="remove_back_logo" class="select-image dnone">
                            ...
                            <a onClick="onMediaImageRemove('back_logo')" class="media-image-remove"
                               href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                          </div>
                        </div>
