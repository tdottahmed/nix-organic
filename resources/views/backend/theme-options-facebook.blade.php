                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label for="fb_app_id">Fb:app_id (<a target="_blank"
                               href="https://developers.facebook.com/docs/apps/">Generator App Id</a>)</label>
                          <input value="{{ $datalist['fb_app_id'] }}" type="text" name="fb_app_id" id="fb_app_id"
