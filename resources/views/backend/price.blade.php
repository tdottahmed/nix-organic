                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['cost_price'] }}" name="cost_price" id="cost_price" type="text"
                                 class="form-control">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['sale_price'] }}" name="sale_price" id="sale_price" type="text"
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['old_price'] }}" name="old_price" id="old_price" type="text"
                                 class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input value="{{ $datalist['end_date'] }}" name="end_date" id="end_date" type="text"
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select name="is_discount" id="is_discount" class="chosen-select form-control">
                            <option {{ 1 == $datalist['is_discount'] ? 'selected=selected' : '' }} value="1">
                              {{ __('YES') }}</option>
                            <option {{ 0 == $datalist['is_discount'] ? 'selected=selected' : '' }} value="0">
                              {{ __('NO') }}</option>
                          </select>
                        </div>
                      </div>
