                      ...
                      <div class="col-lg-8">
                        <div class="form-group">
                          ...
                          <div id="theme_color_picker" class="input-group tw-picker">
                            <input name="theme_color" id="theme_color" type="text"
                                   value="{{ $datalist['theme_color'] == '' ? '#61a402' : $datalist['theme_color'] }}"
                                   class="form-control" />
                        ...
                        <div class="form-group">
                          ...
                          <div id="green_color_picker" class="input-group tw-picker">
                            <input name="green_color" id="green_color" type="text"
                                   value="{{ $datalist['green_color'] == '' ? '#65971e' : $datalist['green_color'] }}"
                                   class="form-control" />
                            <span class="input-group-addon"><i></i></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="light_green_color_picker" class="input-group tw-picker">
                            <input name="light_green_color" id="light_green_color" type="text"
                                   value="{{ $datalist['light_green_color'] == '' ? '#daeac5' : $datalist['light_green_color'] }}"
                                   class="form-control" />
                            <span class="input-group-addon"><i></i></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="lightness_green_color_picker" class="input-group tw-picker">
                            <input name="lightness_green_color" id="lightness_green_color" type="text"
                                   value="{{ $datalist['lightness_green_color'] == '' ? '#fdfff8' : $datalist['lightness_green_color'] }}"
                                   class="form-control" />
                            <span class="input-group-addon"><i></i></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="gray_color_picker" class="input-group tw-picker">
                            <input name="gray_color" id="gray_color" type="text"
                                   value="{{ $datalist['gray_color'] == '' ? '#8d949d' : $datalist['gray_color'] }}"
                                   class="form-control" />
                            <span class="input-group-addon"><i></i></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="dark_gray_color_picker" class="input-group tw-picker">
                            <input name="dark_gray_color" id="dark_gray_color" type="text"
                                   value="{{ $datalist['dark_gray_color'] == '' ? '#595959' : $datalist['dark_gray_color'] }}"
                                   class="form-control" />
                            <span class="input-group-addon"><i></i></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="light_gray_color_picker" class="input-group tw-picker">
                            <input name="light_gray_color" id="light_gray_color" type="text"
                                   value="{{ $datalist['light_gray_color'] == '' ? '#e7e7e7' : $datalist['light_gray_color'] }}"
                                   class="form-control" />
                            <span class="input-group-addon"><i></i></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="black_color_picker" class="input-group tw-picker">
                            <input name="black_color" id="black_color" type="text"
                                   value="{{ $datalist['black_color'] == '' ? '#232424' : $datalist['black_color'] }}"
                                   class="form-control" />
                            <span class="input-group-addon"><i></i></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="white_color_picker" class="input-group tw-picker">
                            <input name="white_color" id="white_color" type="text"
                                   value="{{ $datalist['white_color'] == '' ? '#ffffff' : $datalist['white_color'] }}"
                                   class="form-control" />
                            <span class="input-group-addon"><i></i></span>
                          </div>
                        </div>
