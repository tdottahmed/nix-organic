                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input data-range="[1, 999999]" data-trigger="keyup" type="number" name="amount"
                                     id="amount" class="form-control parsley-validated" data-required="true" readonly>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                  ...
                  <div class="card mb-15">
                    <div class="card-header">
                      <a id="on_thumbnail" href="javascript:void(0);"
                         class="btn blue-btn">{{ __('Add Screenshot') }}</a>
                    </div>
                    <div class="card-body">
                      <div class="seller_card">
