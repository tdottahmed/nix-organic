                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="float-right">
                      <a href="{{ route('backend.products') }}" class="btn warning-btn"><i class="fa fa-reply"></i>
                        {{ __('Back to List') }}</a>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="form-group">
                          ...
                          <select name="storeid" id="storeid" class="chosen-select form-control">
                            @foreach ($storeList as $row)
                              <option {{ $row->id == $datalist['user_id'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->shop_name }}
                              </option>
                            @endforeach
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <div class="tp-upload-field">
                            <input value="{{ $datalist['f_thumbnail'] }}" type="text" name="f_thumbnail"
                                   id="f_thumbnail_thumbnail" class="form-control" readonly>
                          ...
                          <div id="remove_f_thumbnail" class="select-image dnone">
                            ...
                            <a onClick="onMediaImageRemove('f_thumbnail_thumbnail')" class="media-image-remove"
                        ...
                        <div class="form-group">
                          ...
                          <select name="is_publish" id="is_publish" class="chosen-select form-control">
                            @foreach ($statuslist as $row)
                              <option {{ $row->id == $datalist['is_publish'] ? 'selected=selected' : '' }}
                                      value="{{ $row->id }}">
                                {{ $row->status }}
                              </option>
                            @endforeach
