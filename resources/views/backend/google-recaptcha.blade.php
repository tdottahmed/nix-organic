                  ...
                  <div id="GoogleRecaptchaSetting">
                    <form novalidate="" data-validate="parsley" id="GoogleRecaptcha_formId">
                        ...
                        <div class="col-lg-8">
                          <div class="tw_checkbox checkbox_group">
                            <input id="recaptcha" name="recaptcha" type="checkbox"
                                   {{ $datalist['is_recaptcha'] == 1 ? 'checked' : '' }}>
                            <label for="recaptcha">{{ __('Enable/Disable') }}</label>
                            <span></span>
                          </div>
                          <div class="form-group">
                            <label for="sitekey">{{ __('Site Key') }}<span class="red">*</span></label>
                            <input type="text" name="sitekey" id="sitekey" class="form-control parsley-validated"
                                   data-required="true" value="{{ $datalist['sitekey'] }}">
                          </div>
                          <div class="form-group">
                            <label for="secretkey">{{ __('Secret Key') }}<span class="red">*</span></label>
                            <input type="text" name="secretkey" id="secretkey" class="form-control parsley-validated"
                                   data-required="true" value="{{ $datalist['secretkey'] }}">
                            <small class="form-text text-muted"><a target="_blank"
                                 href="https://www.google.com/recaptcha/admin/create">Create Google reCAPTCHA
                                v2</a></small>
                          </div>
                        </div>
                      ...
                      <div class="row tabs-footer mt-15">
                        <div class="col-lg-12">
                          <a id="recaptcha-submit-form" href="javascript:void(0);"
