                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="url" id="url" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div id="color-picker" class="input-group tw-picker">
                          <input name="bg_color" id="bg_color" type="text" value="#38a677"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="text_1" id="text_1" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="text_2" id="text_2" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div id="remove_offer_ads_image" class="select-image">
                          ...
                          <a onClick="onMediaImageRemove('offer_ads_image')" class="media-image-remove"
