                  ...
                  <div class="col-lg-9 mb-10">
                    <div class="group-button">
                      <button type="button" onClick="onDataViewByStatus(0)" id="viewstatus_0"
                              class="btn btn-theme viewstatus active">{{ __('All') }} ({{ $AllCount }})</button>
                      <button type="button" onClick="onDataViewByStatus(1)" id="viewstatus_1"
                              class="btn btn-theme viewstatus">{{ __('Published') }} ({{ $PublishedCount }})</button>
                      <button type="button" onClick="onDataViewByStatus(2)" id="viewstatus_2"
                              class="btn btn-theme viewstatus">{{ __('Draft') }} ({{ $DraftCount }})</button>
                    </div>
              ...
              <div id="form-panel" class="card-body dnone">
                <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                    <div class="col-md-3">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="email" id="email" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="phone" id="phone" class="form-control parsley-validated"
                               data-required="true">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <p class="mb0">If you are not yet added Google Map API key. <strong><a
                             href="{{ route('backend.google-map') }}">Click Here</a></strong></p>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-builder">
                        <a onclick="onAddField()" class="add_field_btn" href="javascript:void(0);"
                           title="{{ __('Add Field') }}"><i class="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row mt-25" id="mailSubjectHideShow">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="mail_subject">{{ __('Select Mail Subject Field') }}<span
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p class="mt-15 mb0"><strong>{{ __('Google reCAPTCHA') }}</strong> (If you are not yet added
                        Google reCAPTCHA key. <strong><a href="{{ route('backend.google-recaptcha') }}">Click
                            Here</a></strong>)</p>
                      <div class="tw_checkbox checkbox_group">
              ...
              <div class="row dnone" id="dropdown_values_id">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="dropdown_values" id="dropdown_values" class="form-control" rows="2"
