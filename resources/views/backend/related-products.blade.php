            ...
            <div class="card">
              ...
              <div class="card-body tabs-area p-0">
                ...
                <div class="tabs-body">
                  <div class="row">
                    <div class="col-lg-7">
                      <a onClick="onAddRelatedProductsModalView()" href="javascript:void(0);"
                         class="btn blue-btn mr-10"><i class="fa fa-plus"></i> {{ __('Add New') }}</a>
                    </div>
                    <div class="col-lg-5">
                  ...
                  <div id="tp_datalist">
                    @include('backend.partials.related_products_table')
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div id="tp_datalist_modal">
                  @include('backend.partials.products_list_for_related_product')
                </div>
              </div>
            </div>
          </div>
...
@push('scripts')
  ...
  <script src="{{ asset('backend/pages/related-products.js') }}"></script>
@endpush
