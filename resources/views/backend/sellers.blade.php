                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="float-right">
                      <a onClick="onFormPanel()" href="javascript:void(0);" class="btn blue-btn btn-form float-right"><i
                  ...
                  <div class="col-lg-12">
                    <div class="group-button">
                      <button id="orderstatus_0" type="button" onclick="onDataViewByStatus(0)"
                              class="btn btn-theme orderstatus active">All ({{ $AllCount }})</button>
                      <button id="orderstatus_1" type="button" onclick="onDataViewByStatus(1)"
                              class="btn btn-theme orderstatus">{{ __('Active') }} ({{ $ActiveCount }})</button>
                      <button id="orderstatus_2" type="button" onclick="onDataViewByStatus(2)"
                              class="btn btn-theme orderstatus">{{ __('Inactive') }} ({{ $InactiveCount }})</button>
                    </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div id="remove_photo_thumbnail" class="select-image">
                                  ...
                                  <a onClick="onMediaImageRemove('photo_thumbnail')" class="media-image-remove"
                ...
                <div class="col-md-3">
                  <div class="card mb-15">
                    <div class="card-body">
                      <div class="seller_card">
                        <h5><strong>{{ __('Joined At') }}</strong> <span class="float-right" id="created_at"></span>
                        </h5>
                        <h6><strong>{{ __('Status') }}</strong> <span id="seller_status" class="float-right"></span>
                        </h6>
                      </div>
                    </div>
                  </div>
                  <div class="status-card bg-grad-5 mb-15">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 200">
                      <path fill="rgba(255,255,255,0.2)" fill-opacity="1"
